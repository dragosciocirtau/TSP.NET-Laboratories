...
namespace Laborator5
{
    class SelfReferenceMethods
    {
        ...
        static void Insert(string name)
        {
            ...
            {
                var it = new SelfReference()
                {
                    Name = name
                };
            
                context.SelfReferences.Add(it);
        ...
        static void display()
        {
            ...
            var query = from b in context.SelfReferences
                        orderby b.SelfReferenceId
                        select b;

            Console.WriteLine("All blogs in the database:");
            foreach (var item in query)
            {
                Console.WriteLine(Convert.ToString(item.SelfReferenceId), item.Name);
            }
        }


        static void ProductsInsert()
        {
        ...
        static void PhotographInsert()
        {
            ...
            { 
                ...
                context.Photographies.Add(photo); 
                context.SaveChanges(); }
        }


        static void PhotographDisplay()
        {
            using (var context = new PhotographContext())
            {
                foreach (var photo in context.Photographies)
                {
        ...
        static void BusinessDisplay()
        {
            ...
            { 
                ...
                { 
                    ...
                    Console.WriteLine("{0}", r.Address); Console.WriteLine("{0}, {1} {2}", r.City, r.State, r.ZIPCode); 
                } 
